...
rows: [
{title: `⫹🗒️ › ${emot}〚 All Menu 〛-𐑂`, rowId: ".? all", description: "╰► Menampilkan Seluruh Command ArexansBot"},
	...
	{title: `⫹👩‍💻 › ${emot}〚 Owner 〛-𐑂`, rowId: ".? owner", description: "╰► Yg bukan developer ArexansBot gausah nge klik fitur ini !"},
...
rows: [
{title: `🔖 ${emot} SEWA`, rowId: ".sewa", description: "Menampilkan list harga sewa ArexansBot"},
